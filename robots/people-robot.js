    ...
    async analyze(enrichedContext) {
        ...
        const analysis = {
            ...
            outputFormat: {
                ...
                htmlRequired: "IMPORTANT: You MUST generate your response as rich HTML in this chat window using white/light backgrounds (DO NOT use dark mode). Include raw HTML blocks with inline styles for all visual components. Plain markdown headings and bullets are fine for text content, but cards, badges, journey maps, and summary tables MUST be HTML with inline styles. When you are done and call the 'save-robot-output' tool, you MUST pass this HTML into the 'htmlText' parameter, AND convert the content to pure, tag-free Markdown and pass it into the 'cleanMarkdown' parameter."
            }
        };
